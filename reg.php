...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($username) || empty($password) || empty($confirm_password) || empty($email) || empty($pid)) {
        ...
        // For example, using PDO or MySQLi to store the admin information

        // Example:
        // $hashed_password = password_hash($password, PASSWORD_DEFAULT);
        // Save $username, $hashed_password, $email, and $pid to the database

        // Redirect to addash.php after successful registration
